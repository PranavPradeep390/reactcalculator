  ...
  return (
    <>
      <div  style={{ width: '100%', height: '100vh' }} className='d-flex align-items-center justify-content-center '>
        <div id='allover' style={{ width: '450px', height: '600px' }} className='box d-flex align-items-center justify-content-center'>
          <div id='main' style={{ width: '370px', height: '585px', paddingLeft: '25px', backgroundColor: ' rgb(60, 58, 58)', borderRadius: '10px' }}
